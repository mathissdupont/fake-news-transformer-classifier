...
| 2026-05-12 | Copilot | Sprint plan update | Mark completed sprint items, add missing tasks, and align explanations with the current project state | Reviewed by the team and accepted after manual checks |
| 2026-05-12 | Copilot | Process note update | Add a learning-focused note to the sprint plan so the team records why choices were made, not just what was finished | Reviewed by the team and accepted after manual checks |
| 2026-05-12 | Copilot | Turkish summary note | Create a Turkish note summarizing what has been done so far and explaining technical terms in plain language | Reviewed by the team and accepted after manual checks |
| 2026-05-19 | ChatGPT Codex | Execution and debugging | Set up local virtual environment, ran embedding training, fixed evaluation plotting backend, generated final metrics table and F1 comparison plot | Reviewed by the team and accepted after manual checks |
